            ...
            <div class="login-box">
                <div class="login-snip"> <input id="tab-1" type="radio" name="tab" class="sign-in" checked><label for="tab-1" class="tab">Login</label> <input id="tab-2" type="radio" name="tab" class="sign-up"><label for="tab-2" class="tab"></label>
                    <div class="login-space">
                        <div class="login">
                            <div class="group"> <label for="dEmail" class="label">dEmail</label> <input id="dEmail" type="text" name ="dEmail" class="input" placeholder="Enter your email"> </div>
                            <div class="group"> <label for="dPassword" class="label">dPassword</label> <input id="dPassword" type="password" class="input" data-type="password" name="dPassword" placeholder="Enter your password"> </div>
                            
                            <div class="group"> <input type="submit" class="button" value="Login"> </div>
                              <div class="foot"> <a  href='<spring:url value="/driver/register"/>' >New User Register</a> </div>
                            <div class="hr"></div>
